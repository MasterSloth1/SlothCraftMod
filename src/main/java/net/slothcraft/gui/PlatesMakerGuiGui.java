...
public class PlatesMakerGuiGui extends SlothCraftElements.ModElement {
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("platesmakergui"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("slothcraft:textures/platesmakergui.png");
		@Override
		...
		if (slotID == 0 && changeType == 0) {
			{
				...
				ItemMoverPlatesMakerProcedureProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
