...
public class MithrilPlateItemItem extends SlothCraftElements.ModElement {
	@ObjectHolder("slothcraft:mithrilplateitem")
	public static final Item block = null;
	public MithrilPlateItemItem(SlothCraftElements instance) {
		super(instance, 91);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("mithrilplateitem");
		}
