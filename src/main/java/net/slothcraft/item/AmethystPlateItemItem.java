...
public class AmethystPlateItemItem extends SlothCraftElements.ModElement {
	@ObjectHolder("slothcraft:amethystplateitem")
	public static final Item block = null;
	public AmethystPlateItemItem(SlothCraftElements instance) {
		super(instance, 76);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("amethystplateitem");
		}
