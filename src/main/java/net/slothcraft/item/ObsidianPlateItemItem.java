...
public class ObsidianPlateItemItem extends SlothCraftElements.ModElement {
	@ObjectHolder("slothcraft:obsidianplateitem")
	public static final Item block = null;
	public ObsidianPlateItemItem(SlothCraftElements instance) {
		super(instance, 93);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("obsidianplateitem");
		}
