...
public class QuartzPlateItemItem extends SlothCraftElements.ModElement {
	@ObjectHolder("slothcraft:quartzplateitem")
	public static final Item block = null;
	public QuartzPlateItemItem(SlothCraftElements instance) {
		super(instance, 96);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("quartzplateitem");
		}
