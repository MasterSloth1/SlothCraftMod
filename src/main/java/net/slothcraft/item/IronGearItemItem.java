...
public class IronGearItemItem extends SlothCraftElements.ModElement {
	@ObjectHolder("slothcraft:irongearitem")
	public static final Item block = null;
	public IronGearItemItem(SlothCraftElements instance) {
		super(instance, 13);
	}
