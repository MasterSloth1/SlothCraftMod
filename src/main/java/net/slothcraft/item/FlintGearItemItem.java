...
public class FlintGearItemItem extends SlothCraftElements.ModElement {
	@ObjectHolder("slothcraft:flintgearitem")
	public static final Item block = null;
	public FlintGearItemItem(SlothCraftElements instance) {
		super(instance, 7);
	}
