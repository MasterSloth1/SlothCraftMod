...
public class ChromiumPlateItemItem extends SlothCraftElements.ModElement {
	@ObjectHolder("slothcraft:chromiumplateitem")
	public static final Item block = null;
	public ChromiumPlateItemItem(SlothCraftElements instance) {
		super(instance, 77);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("chromiumplateitem");
		}
