...
public class PlatinumPlateItemItem extends SlothCraftElements.ModElement {
	@ObjectHolder("slothcraft:platinumplateitem")
	public static final Item block = null;
	public PlatinumPlateItemItem(SlothCraftElements instance) {
		super(instance, 95);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("platinumplateitem");
		}
