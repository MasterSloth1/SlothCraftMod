...
public class CopperPlateItemItem extends SlothCraftElements.ModElement {
	@ObjectHolder("slothcraft:copperplateitem")
	public static final Item block = null;
	public CopperPlateItemItem(SlothCraftElements instance) {
		super(instance, 78);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("copperplateitem");
		}
