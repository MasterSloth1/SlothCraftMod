...
public class SteelGearItemItem extends SlothCraftElements.ModElement {
	@ObjectHolder("slothcraft:steelgearitem")
	public static final Item block = null;
	public SteelGearItemItem(SlothCraftElements instance) {
		super(instance, 26);
	}
