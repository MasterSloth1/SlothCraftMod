...
public class GobberGearItemItem extends SlothCraftElements.ModElement {
	@ObjectHolder("slothcraft:gobbergearitem")
	public static final Item block = null;
	public GobberGearItemItem(SlothCraftElements instance) {
		super(instance, 9);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("gobbergearitem");
		}
