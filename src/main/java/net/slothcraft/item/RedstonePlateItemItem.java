...
public class RedstonePlateItemItem extends SlothCraftElements.ModElement {
	@ObjectHolder("slothcraft:redstoneplateitem")
	public static final Item block = null;
	public RedstonePlateItemItem(SlothCraftElements instance) {
		super(instance, 97);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("redstoneplateitem");
		}
