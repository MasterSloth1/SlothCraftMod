...
public class DiamondPlateItemItem extends SlothCraftElements.ModElement {
	@ObjectHolder("slothcraft:diamondplateitem")
	public static final Item block = null;
	public DiamondPlateItemItem(SlothCraftElements instance) {
		super(instance, 79);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("diamondplateitem");
		}
