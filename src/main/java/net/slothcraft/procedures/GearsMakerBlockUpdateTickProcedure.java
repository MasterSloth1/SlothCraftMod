...
public class GearsMakerBlockUpdateTickProcedure extends SlothCraftElements.ModElement {
	public GearsMakerBlockUpdateTickProcedure(SlothCraftElements instance) {
		super(instance, 35);
	}
