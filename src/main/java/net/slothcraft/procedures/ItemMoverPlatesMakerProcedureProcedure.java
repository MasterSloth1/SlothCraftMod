...
public class ItemMoverPlatesMakerProcedureProcedure extends SlothcraftModElements.ModElement {
	public ItemMoverPlatesMakerProcedureProcedure(SlothcraftModElements instance) {
		super(instance, 142);
	}
		...
		if (((new Object() {
			...
			}
			{
				...
				if (_ent != null) {
					...
					final ItemStack _setstack = new ItemStack(PlateHammerItemItem.block, (int) (1));
